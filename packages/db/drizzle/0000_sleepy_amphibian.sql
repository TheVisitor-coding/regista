CREATE TYPE "public"."user_status" AS ENUM('pending_verification', 'active', 'inactive', 'banned', 'deleted');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"username_changes_remaining" integer DEFAULT 1 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE INDEX "users_status_last_active_idx" ON "users" USING btree ("status","last_active_at");